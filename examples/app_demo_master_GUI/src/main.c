...
int main() 
{
    ...
    ECat_parameters params;

    pthread_t user_application_thread;

    /*int target_position = 100000; // ticks
//    int target_position = 2620000; // ticks
    ...
    pthread_create(&user_application_thread, NULL, user_application, &params);
    ...
    while(1) {
        ...
        steps = init_position_profile_params(relative_target_position,
                actual_position, params.velocity, params.acceleration,
                params.deceleration, ECAT_SLAVE_0, slv_handles);
        ...
        for (int step = 1; step < steps + 1; step++) {
            ...
            if (master_setup.op_flag) /*Check if the master is active*/
            {
                ...
                //Sprintf("\r    Position: %7.d    Velocity: %6.d    Torque: %6.2f        ", actual_position, actual_velocity, actual_torque);
            }
        }
