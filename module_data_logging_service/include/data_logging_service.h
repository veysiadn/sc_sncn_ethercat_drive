...
#define CONFIG_LOG_ERR_TITLE "ERR_%s = "
...
#define CONFIG_MAX_STRING_SIZE 1024
...
typedef struct {
    ...
    unsigned int data_timer_interval;
    unsigned int error_timer_interval;
    unsigned int max_log_file_size;
    unsigned char err_codes_count;
